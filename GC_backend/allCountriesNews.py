...
def fetchNewsArticle(country):
    ...
    for article in articles:
        ...
        if article_count > 3:
            ...
            title_element_div = article.find_all('div', {"class": 'm5k28'})
            title_element = title_element_div[0].find_all('div', {"class": 'B6pJDd'})[0].find_all('div')[0].find_all('a') if title_element_div else []
